...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'social_post', 'mood', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'Post.mood'
        db.alter_column(u'social_post', 'mood', self.gf('django.db.models.fields.SmallIntegerField')())
