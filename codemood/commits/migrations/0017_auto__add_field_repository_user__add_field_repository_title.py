...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.user'
        db.add_column(u'commits_repository', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Repository.title'
        db.add_column(u'commits_repository', 'title',
                      self.gf('django.db.models.fields.CharField')(default='repo name', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.user'
        db.delete_column(u'commits_repository', 'user_id')

        # Deleting field 'Repository.title'
        db.delete_column(u'commits_repository', 'title')
