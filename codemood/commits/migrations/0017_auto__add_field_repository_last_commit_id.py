...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.last_commit_id'
        db.add_column(u'commits_repository', 'last_commit_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.last_commit_id'
        db.delete_column(u'commits_repository', 'last_commit_id')
