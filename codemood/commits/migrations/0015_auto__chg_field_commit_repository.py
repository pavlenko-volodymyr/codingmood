...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Commit.repository'
        db.alter_column(u'commits_commit', 'repository_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['commits.Repository']))

    def backwards(self, orm):

        # Changing field 'Commit.repository'
        db.alter_column(u'commits_commit', 'repository_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['commits.Repository']))
